...
export function PageHero({ title, subtitle, imageUrl = "/images/hero-cossacks-bg.jpg" }: PageHeroProps) {
  return (
    <section className="relative min-h-[220px] overflow-hidden py-20 text-white">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-dark-blue/85 via-dark-blue/55 to-dark-blue/35" />
